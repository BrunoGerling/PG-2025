...
int main()
{
    ...
    //Instanciando 5 triângulos com coordenadas diferentes
	vector<GLuint> VAOs;
	VAOs.push_back(createTriangle(-0.65, 0.33, -0.27, 0.53, -0.61, 0.79));
    VAOs.push_back(createTriangle(0.0f, 0.0f, 0.3f, 0.0f, 0.15f, 0.4f));
    VAOs.push_back(createTriangle(-0.9f, -0.9f, -0.7f, -0.9f, -0.8f, -0.7f));
    VAOs.push_back(createTriangle(0.6f, 0.6f, 0.8f, 0.6f, 0.7f, 0.8f));
    VAOs.push_back(createTriangle(-0.2f, -0.2f, 0.2f, -0.2f, 0.0f, 0.2f));
